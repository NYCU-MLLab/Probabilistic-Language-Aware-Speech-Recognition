...
class Speech2Text:
    ...
    def __init__(
        ...
        if token_type == "hugging_face":
            ...
            # prefix_tok = list(converter.tokenizer.prefix_tokens)
            # prefix_tok = [50258, 50260, 50259, 50359, 50363] # sot zh en asr notimestamps
            prefix_tok = [50258, 50259, 50359, 50363] # sot en asr notimestamps
            if lang_tok == "en":
                prefix_tok.pop(1)
            elif lang_tok == "zh":
                prefix_tok.pop(2)
            # print("prefix tok = ", prefix_tok)
...
def get_parser():
    ...
    group.add_argument(
        ...
        type=str_or_none,
        default=None,
        help="Language token for Whisper, default: <zh><en>",
    )
