...
class Trainer:
    ...
    def train_one_epoch(
        ...
        # def id2string(text):
        #     ans = tokenizer.convert_ids_to_tokens(text, skip_special_tokens=True)
        #     ans = tokenizer.convert_tokens_to_string(ans)
        #     return ans
        
        # def string2id(text):
        #     ans = tokenizer._tokenize(text)
        #     ans = tokenizer.convert_tokens_to_ids(ans)
        #     return ans
        
        # def remove_english_words(text):
        #     # Use regex to remove all English words
        #     # English words: \b\w+\b
        ...
        #     # Use regex to remove all Chinese characters
        ...
        # def func_sule(batch_text):
        #     strings = [id2string(i) for i in batch_text]
        #     zh_strings = [remove_english_words(i) for i in strings if remove_english_words(i) != '']
        #     en_strings = [remove_chinese_words(i) for i in strings if remove_chinese_words(i) != '']
        #     en_toks = [string2id(i) for i in en_strings]
        #     zh_toks = [string2id(i) for i in zh_strings]
        #     english_tokens.update(sum(en_toks, []))
        #     chinese_tokens.update(sum(zh_toks, []))
        #     return
        # tokenizer.convert_ids_to_tokens(text, skip_special_tokens=True)
        ...
        #     assert isinstance(batch, dict), type(batch)
            ...
            # ---------------------------- edit here --------------------------------
            # strings = [id2string(i) for i in batch['text']]
            # zh_strings = [remove_english_words(i) for i in strings if remove_english_words(i) != '']
            # en_strings = [remove_chinese_words(i) for i in strings if remove_chinese_words(i) != '']
            # en_toks = [string2id(i) for i in en_strings]
            # zh_toks = [string2id(i) for i in zh_strings]
            ...
            # common_tokens = english_tokens.intersection(chinese_tokens)
            # with open('/home/en_toks.txt', 'w') as file:
            #     for item in english_tokens:
            #         file.write(f"{item}\n")
            # with open('/home/zh_toks.txt', 'w') as file:
            #     for item in chinese_tokens:
            #         file.write(f"{item}\n")
            # with open('/home/intersection_toks.txt', 'w') as file:
