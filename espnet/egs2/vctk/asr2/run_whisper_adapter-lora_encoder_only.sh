...
asr_config=conf/whisper/train_asr_whisper_small_adapter-lora_encoder_only.yaml
inference_config=conf/whisper/decode_asr_whisper.yaml

freeze_param="freeze_decoder_adapter"
use_lm=false
use_wordlm=false
...
./asr.sh \
    ...
    --asr_tag "NTUT_whisper_small_adapter-lora_e15_r10_idim5_encoder_only" \
